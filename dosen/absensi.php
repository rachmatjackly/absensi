            ...
            <div class="card shadow mb-4">
                ...
                <div class="collapse hide" id="absen">
                  ...
                  <div class="form-group">
                    ...
                    <?php
                        $sql_kelas=mysqli_query($koneksi,"select distinct id_kelas from absen_dosen where npm='$dosen_id'");
                        while($data=mysqli_fetch_array($sql_kelas)){
                          $id = $data['id_kelas'];
                          // var_dump($id);
                          $kelas = mysqli_query($koneksi, "Select id_kelas, nama_kelas from kelas where id_kelas = '$data[id_kelas]'");
                          while($nama=mysqli_fetch_array($kelas)){
                            
                          echo "<option value='$nama[id_kelas]'> $nama[nama_kelas] </option>";
                          }
                        }     
                  ...
                  <div class="form-group">
                        ...
                        <select id="jadwal" class="form-control" name="pekan">
                  ...
                  <div class="form-group">
                    ...
                    <?php
                        ...
                        while($data=mysqli_fetch_array($sql_kelas)){
                          ...
                          while($nama=mysqli_fetch_array($kelas)){
                            $idd = $nama['id_kelas'];
                            $nama_kelas= $nama['nama_kelas'];
                          echo "<option value='$idd'> $nama_kelas </option>";
                          }
                        }     
