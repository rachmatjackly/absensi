      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Ubah Absensi </h1>
			...
			<?php
            $sql="SELECT mahasiswa.nama, kelas.nama_kelas FROM mahasiswa join kelas on mahasiswa.id_kelas=kelas.id_kelas WHERE mahasiswa.npm_nidn='$npm'";
            ...
            <div class="card-body">             
              <div class="table-responsive">
                  <table class="table table-bordered" id="" width="100%" cellspacing="0">
                    ...
                    <tbody align="center">
                        <?php
                        $sql="SELECT * FROM `absen_mahasiswa` WHERE id_kelas='$id_kelas' AND npm='$npm'";
                        $query=mysqli_query($koneksi,$sql);
