...
<div class="container-fluid">
	  ...
	  <div class="card-body">
        ...
        <!-- <div class="form-group">
	    		<label>Email</label>
	    		<input type="text" name="email" value="<?=@$vemail?>" class="form-control" placeholder="Input Email anda disini!" required>
	    	</div>
        <div class="form-group">
	    		<label>Password</label>
	    		<input type="password" name="password" value="<?=@$vpassword?>" class="form-control" placeholder="Input Password anda disini!" required>
	    	</div> --> 
        <!-- <div class="form-group">
	    		<label>Ulangi Password</label>
	    		<input type="password" name="password" value="<?=@$vpassword2?>" class="form-control" placeholder="Input Password anda disini!" required>
	    	</div>-->
