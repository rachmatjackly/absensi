<?php
  ...
  $jumlah_matkul=mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM dosen WHERE npm_nidn='$dosen_id'"));
  $jumlah_kelas=mysqli_num_rows(mysqli_query($koneksi,"SELECT Distinct id_kelas FROM absen_dosen WHERE npm='$dosen_id'"));
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <span class="mr-2 d-none d-lg-inline text-gray-600 medium">Terakhir Login : <span class="text-danger"><?=$dosen_last_login?></span></span>
            </li>
