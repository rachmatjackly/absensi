...
if(isset($_POST["tambah"])){
    if(tambah_matkul($_POST)>0){
        echo "<script>
            alert('Mata Kuliah baru telah ditambahkan');
...
<div class="container-fluid">
	  ...
	  <div class="card-body">
		...
		<div class="form-group">
	    		...
	    		<input type="text" name="kode" value="" class="form-control" placeholder="Masukkan Kode Mata Kuliah" required>
	    	</div>

		<div class="form-group">
	    		<label>Nama Mata Kuliah</label>
	    		<input type="text" name="nama_matkul" value="" class="form-control" placeholder="Masukkan Nama Mata Kuliah" required>
	    	</div>

		<div class="form-group">
	    		<label>Jenis Mata Kuliah</label>
	    		<select name="jenis" id="" class="form-control form-control-mg radius">
                    <option value="mp">MP</option>
                    <option value="mkdk">Mata Kuliah Dasar Kependidikan</option>
